...
public class DeleteUser extends ActionBarActivity implements SearchView.OnQueryTextListener {
                    ...
                    try {
                        ...
                        recyclerView.addOnItemTouchListener(new RecyclerItemClickListener(getApplicationContext(), new RecyclerItemClickListener.OnItemClickListener() {
                            ...
                            public void onItemClick(View view, int position) {
                                ...
                                final ProgressDialog dlg = new ProgressDialog(DeleteUser.this);
                                dlg.setTitle("Please Wait...");
                                dlg.setMessage("Deleting user. Please wait.");
                                dlg.show();
                                ...
                                query1.findInBackground(new FindCallback<ParseObject>() {
                                        ...
                                        if (e == null && objects != null) {
                                            try {
                                                ...
                                                if (p != null) {
                                                    ...
                                                    dlg.cancel();
                                                    Toast.makeText(DeleteUser.this, title23.getText().toString() + " deleted", Toast.LENGTH_SHORT).show();
                                                    startActivity(new Intent(DeleteUser.this, DeleteUser.class));
                                                } else {
                                                    dlg.cancel();
                                                    Toast.makeText(DeleteUser.this, "No such user ", Toast.LENGTH_SHORT).show();
                                                }
                                    ...
                                    /*
                                        ...
                                        if(p!=null) {
                                            ...
                                            p.deleteInBackground();
                                            dlg.cancel();
                                            Toast.makeText(DeleteUser.this, fsname + " deleted", Toast.LENGTH_SHORT).show();
                                            startActivity(new Intent(DeleteUser.this,DeleteUser.class));
                                        }
                                        else{
                                            dlg.cancel();
                        ...
                        startActivity(intent);*/
                                                ...
                                                Toast.makeText(DeleteUser.this, "Error", Toast.LENGTH_SHORT).show();


                                            }
                                        } else if (objects == null) {
                                            Toast.makeText(DeleteUser.this, "Invalid data", Toast.LENGTH_SHORT).show();
                                        }
